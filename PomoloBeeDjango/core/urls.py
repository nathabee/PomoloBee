...
urlpatterns = [
    ...
    path('manual_estimation/', ManualEstimationView.as_view(), name='manual-estimation'),  # ✅ POST from App to get an estimation
    path('images/list/', ImageListView.as_view(), name='image-list'),  # ✅ GET /api/images/
